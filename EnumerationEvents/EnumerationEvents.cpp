  ...
  public:
    ...
    void OnDeviceArrival(CameraPtr pCamera)
    {
        ...
        else
        {
            ...
            const std::string arrivalMsg = "\tDevice " + std::string(pCamera->GetDeviceSerialNumber()) +
    ...
    void OnDeviceRemoval(CameraPtr pCamera)
    {
        ...
        {
            cout << "Interface event handler:\n";
            const std::string removalMsg = "\tDevice " + std::string(pCamera->GetDeviceSerialNumber()) +

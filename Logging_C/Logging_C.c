...
int main(/*int argc, char** argv*/)
{
    ...
    if (err != SPINNAKER_ERR_SUCCESS)
    {
        printf("Unable to create log event. Aborting with error: %s [%d]\n\n", GetLastErrorMessage(), err);
        return err;
    }
    ...
    if (err != SPINNAKER_ERR_SUCCESS)
    {
        printf("Unable to register log event. Aborting with error: %s [%d]\n\n", GetLastErrorMessage(), err);
        return err;
    }
    ...
    if (err != SPINNAKER_ERR_SUCCESS)
    {
        printf("Unable to set logging level. Aborting with error: %s [%d]\n\n", GetLastErrorMessage(), err);
        return err;
    }
    ...
    if (err != SPINNAKER_ERR_SUCCESS)
    {
        printf("Unable to unregister log event. Aborting with error: %s [%d]\n\n", GetLastErrorMessage(), err);
        return err;
    }
    ...
    if (err != SPINNAKER_ERR_SUCCESS)
    {
        printf("Unable to destroy log event. Aborting with error: %s [%d]\n\n", GetLastErrorMessage(), err);
        return err;
    }
